  ...
  <div class="feedback"> 
   <div class="container"> 
    ...
    <div class="feedback-top"> 
     <form action="user_sugges"> 
      <input name="title" type="text" placeholder="主题 " required="" /> 
      <textarea name="suggestion" placeholder="描述" requried=""></textarea> 
      <label class="hvr-sweep-to-right"> <input type="submit" value="反馈" /> </label> 
     </form> 
    </div> 
   </div> 
  </div> 
