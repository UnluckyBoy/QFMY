  ...
  <div class="login-right"> 
   <div class="container"> 
    ...
    <div class="login-top"> 
     <div class="form-info"> 
      <form action="doregis"> 
       <input name="tel" type="text" placeholder="账户" required="" /> 
       <input name="password" type="password" placeholder="密码" required="" /> 
       <input name="password_accep" type="password" placeholder="确认密码" required="" /> 
       <input name="name" type="text" placeholder="名称" required="" /> 
       <input name="age" type="text" placeholder="年龄" required="" /> 
       <input name="sex" type="text" placeholder="性别 " required="" /> 
       <label class="hvr-sweep-to-right"> <input type="submit" value="确认" /> </label> 
      </form> 
      <p>是否已有账户? <a href="login">登录</a></p> 
     </div> 
    </div> 
   </div> 
  </div> 
